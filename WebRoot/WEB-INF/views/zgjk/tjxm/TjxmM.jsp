...
<table width="100%" >
	<tr>
		...
		<td width="100%" class="ver01" >
				...
				<form action="<c:url value='/zgjk/tjxm/search'/>" id="queryForm" method="post">
 ...
 <script type="text/javascript">
	...
	var selectionSetting = {
			async: {
				...
				//返回的JSON数据的名字
				//dataName: 'treeNodes',
				url: "<c:url value='/zgjk/tjxm/tree' />",
				autoParam: ["id"]
			},
			callback: {
			    onClick: zTreeSelect
	...
	function initGrid() {
		grid = $("#dataBasic").quiGrid({
			columns:[
				...
				{ display: '异常值小于', name: 'typeValueH',     align: 'left', width: "5%"},
				{ display: '异常值大于', name: 'typeValueL',     align: 'left', width: "5%"},
		 ...
		 url: "<c:url value='/zgjk/tjxm/list'/>", sortName: 'id',rownumbers:true,checkbox:true,
	...
	function onDelete(rowid,rowidx){
		top.Dialog.confirm("确定要删除该记录吗？",function(){
		  	//删除记录
		  	$.post("<c:url value='/zgjk/tjxm/delBatch'/>",
