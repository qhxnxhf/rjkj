...
<body>
	...
	<form id="myFormId" action="<c:url value='/cms/lm/saveAdd'/>" method="post" target="frmright">
	...
	<table class="tableStyle" formMode="line" >
		<tr>
			...
			<td >
					...
					<input type="hidden" name="parent.orgIdsMl" value="${dic.parent.orgIdsMl}"/>
					<input type="hidden" name="parent.orgIdsWj" value="${dic.parent.orgIdsWj}"/>
					<input type="text" name="parent.name" value="${dic.parent.lmName}" style="width:350px;"/>
			</td>
		</tr>
		<tr>
			<td >序号：</td>
		...
		<tr>
			<td >名称：</td>
			<td>
				<input type="text" name="lmName" class="validate[required]" watermark="请输入" style="width:350px;"/><span class="star">*</span>
			</td>
		</tr>
		<tr>
			<td >图标：</td>
			<td>
			<input type="text" id="lmIcon" name="lmIcon"  style="width:350px;" />
		...
		<tr>
			<td >URL：</td>
			<td>
				<input type="text" name="linkUrl"  watermark="请输入" style="width:350px;"/>
			</td>
		</tr>
		<tr>
			<td>Target：</td>
			<td>
				<select  name="target"  data='{"list":[{"value":"_blank","key":"新页"},{"value":"frmright","key":"当前"}]}' selWidth="350" >
				</select>
		...
		<tr>
			<td>类别：</td>
			<td>
				<select  name="nodeType"  data='{"list":[{"value":"b","key":"分类"},{"value":"y","key":"叶子"},{"value":"u","key":"链接"}]}' selWidth="350" >
				</select>
		...
		<tr>
			...
			<td>
				...
				<select boxHeight="100" name='moduleId' id="moduleId" class="validate[required]"  prompt="请选择" url="<c:url value='/sys/dic/dicSelect?parentId=3'/>"  selWidth="140" ></select>      
		...
		<tr>
			<td>状态：</td>
			<td>
				<select  name="status"  data='{"list":[{"value":"y","key":"有效"},{"value":"n","key":"无效"}]}' selWidth="350" >
				</select>
		...
		<tr>
			<td >简介：</td>
			<td>
			<textarea name="lmBrief"  style="width:350px;height:80px;" ></textarea><span class="star">*</span>
