    ...
    function navList(lmurl,lmId,size,target){  
    	$.ajax({  
	        ...
	        success: function(result){  
		       ...
		       item='<ul class="nav-left"><li class="bg-title red"><a ><strong class="font-hei">'+result.title+'</strong></a></li>';
		        ...
		        $.each(result.tabs, function (index, obj) {
		        	...
		        	item=item+'<li class="bg-title red" onClick=navclick("'+obj.lmName+'","'+obj.id+'") ><a ><i></i>'+obj.lmName+'</a></li>';
		        });
		        item=item+"</ul>";
				target.empty();
				target.html(item) ;
     ...
     <div class="wrapper">
        ...
        <div class="main">
            <div class="layout-left" id="navleft">
                <ul class="nav-left">
                    <li class="bg-title red"><a href="List.html"><strong class="font-hei">栏目栏目</strong></a></li>
                    <li class="bg-title red"><a href="List.html"><i></i>栏目栏目</a></li>
                    <li class="bg-title red"><a href="List.html"><i></i>栏目栏目</a></li>
                    <li class="bg-title red"><a href="List.html"><i></i>栏目栏目</a></li>
                    <li class="bg-title red"><a href="List.html"><i></i>栏目栏目</a></li>
                    <li class="bg-title red"><a href="List.html"><i></i>栏目栏目</a></li>
