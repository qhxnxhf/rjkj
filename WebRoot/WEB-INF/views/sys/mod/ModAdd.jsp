...
<body>
	<form id="myFormId" action="<c:url value='/sys/mod/add'/>" method="post" target="frmright">
	...
	<table class="tableStyle" formMode="transparent">
		...
		<tr>
			...
			<td>
				<input type="text" name="modName" class="validate[required]" watermark="请输入" style="width:300px;" /><span class="star">*</span>
		...
		<tr>
			...
			<td>
				<input type="text" name="sn" class="validate[required]" watermark="请输入英文或数字" style="width:300px;" /><span class="star">*</span>
		...
		<tr>
			<td>节点类别：</td>
			<td>
				<select selectedValue="${module.nodeType}" name="nodeType" selWidth="300" data='{"list":[{"value":"b","key":"分类"},{"value":"m","key":"功能"},{"value":"y","key":"权限"}]}'  >
				</select>
		...
		<tr>
			...
			<td>
				<input type="text" name="url" class="validate[required]" watermark="请输入英文或数字" style="width:300px;" /><span class="star">*</span>
		...
		<tr>
			<td width="150">简介：</td>
			<td><input type="text" name="modBrief"  value="" class="validate[length[0,20]]" style="width:300px;" /><span class="star">*</span></td>
		</tr>
