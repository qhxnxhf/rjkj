 ...
 <script type="text/javascript">
	...
	function initGrid() {
		grid = $("#dataBasic").quiGrid({
		 ...
		 url: "<c:url value='/sys/org/treelist'/>", sortName: 'id',rownumbers:true,checkbox:true,
	...
	function onAllowed(rowid){
		  	$.post("<c:url value='/sys/org/allowed'/>",
		  			{"orgid":rowid,"CSRFToken":$("#CSRFToken").val()},
		  			function(result){
		  				//handleResult(result);
		  				getToken();
		  				grid.loadData();
	...
	function onView(rowid){	
		top.Dialog.open({
			URL:"<c:url value='/sys/org/view?orgid='/>" + rowid,
	...
	function addUnit() {
		...
		if(orgid != null && orgid != ""){
			...
			if(selectTreeNode.menuType=="y"){
				...
				top.Dialog.open({
				URL:"<c:url value='/sys/org/preAdd?orgid='/>" + orgid,
	...
	function inheritUnit() {
		...
		alert(orgid);
		if(orgid != null && orgid != ""){
			$.post("<c:url value='/sys/org/inherit'/>",
	...
	function onEdit(rowid){
		...
		top.Dialog.open({
			URL:"<c:url value='/sys/org/preEdit?orgid='/>" + rowid,
