...
<body>
	<form id="myFormId" action="<c:url value='/sys/user/add' />" method="post" target="frmright" >
	...
	<table class="tableStyle" formMode="line" >
		...
		<tr>
			...
			<input id="CSRFToken" name="CSRFToken" type="hidden" value="${CSRFToken}"/>
				<input type="text"  name="loginName" value="${user.loginName}"  class="validate[required,length[0,20]]" style="width:200px;" /><span id="forusername" class="star">*</span>
		...
		<tr>
			<td width="150">姓名：</td>
			<td>
				<input type="text" id="username" name="userName" value="${user.userName}" class="validate[required]"  style="width:200px;"/><span class="star">*</span>
		...
		<tr>
			...
			<td>
				...
				<input type="text"  name="orgName" value="${user.org.orgName}"  class="validate[required,length[0,20]]" style="width:200px;" /><span class="star">*</span>
				
				<input type="hidden"  name="org.id" value="${user.org.id}"   />
		...
		<tr>
			...
			<td>
				<div style="width:200px;" class="checkboxRender">
					<input type="radio" class="validate[required] radio" id="radio-1" name="status" value="1" /><label for="radio-1" class="hand">激活</label>
					<input type="radio" class="validate[required] radio" id="radio-2" name="status" value="2"/><label for="radio-2" class="hand">离线</label>
					<input type="radio" class="validate[required] radio" id="radio-3" name="status" value="3" /><label for="radio-1" class="hand">在线</label>
					<input type="radio" class="validate[required] radio" id="radio-4" name="status" value="4"/><label for="radio-2" class="hand">锁定</label><span class="star">*</span>
