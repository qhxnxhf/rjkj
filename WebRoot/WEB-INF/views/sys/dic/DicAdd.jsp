...
<body>
	<form id="myFormId" action="<c:url value='/sys/dic/saveAdd' />" method="post" target="frmright">
	...
	<table class="tableStyle" formMode="line" >
		...
		<tr>
			<td >名称：</td>
			<td>
				<input type="text" name="dicName" class="validate[required]" watermark="请输入" style="width:350px;"/><span class="star">*</span>
			</td>
		</tr>
		<tr>
			<td>类别：</td>
			<td>
				<select  name="nodeType"  data='{"list":[{"value":"b","key":"分类"},{"value":"d","key":"单位"},{"value":"y","key":"部门"}]}' selWidth="350" >
				</select>
		...
		<tr>
			<td>关键字：</td>
			<td>
				<input type="text" name="dicKey" style="width:350px;"/><span class="star">*</span>
			</td>
		</tr>
		<tr>
			<td >值1：</td>
			<td>
				...
				<textarea name="value1"  style="width:350px;height:80px;" ></textarea><span class="star">*</span>
			</td>
		</tr>
		<tr>
			<td >值2：</td>
			<td>
				...
				<textarea name="value2"  style="width:350px;height:80px;" ></textarea><span class="star">*</span>
			</td>
		</tr>
		...
		<tr>
			<td >简介：</td>
			<td><input type="text" name="dicBrief"   class="validate[length[0,20]]" style="width:350px;"/><span class="star">*</span></td>
		</tr>
