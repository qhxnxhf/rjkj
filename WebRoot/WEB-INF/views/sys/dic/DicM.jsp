...
<table width="100%" >
	<tr>
		<!--左侧区域start-->
		<td class="ver01" >
			 <div class="box2"  overflow="auto" showStatus="false" panelTitle="字典目录">
		...
		<td width="100%" class="ver01" >
				<form action="<c:url value='/sys/dic/search' />" id="queryForm" method="post">
 ...
 <script type="text/javascript">
	...
	function initGrid() {
		grid = $("#dataBasic").quiGrid({
			columns:[
				...
				{ display: '序号', name: 'dicOrder',     align: 'left', width: "5%"},
				{ display: '父节点', name: 'parent.dicName',     align: 'left', width: "10%"},
				{ display: '名称', name: 'dicName',     align: 'left', width: "10%"},
				{ display: '键', name: 'dicKey',     align: 'left', width: "5%"},
				{ display: '值1', name: 'value1',     align: 'left', width: "20%"},
				{ display: '值2', name: 'value2',     align: 'left', width: "20%"},
		 ...
		 url: '<c:url value='/sys/dic/treelist' />', sortName: 'id',rownumbers:true,checkbox:true,
	...
	function renderType(value){
        ...
        if(value=="d"){
           return "<font color=blue>单位节点 </font>";
        }else{
           return "<font color=green>部门节点 </font>";
        }
	}
	...
	function addUnit() {
		...
		if(orgid != null && orgid != ""){
			...
			if(selectTreeNode.menuType=="y"){
				...
				top.Dialog.open({
				URL:"<c:url value='/sys/dic/preAdd?orgid='/>" + orgid,
	...
	function onEdit(rowid){
		...
		top.Dialog.open({
			URL:"<c:url value='/sys/dic/preEdit?orgid='/>"+ rowid,
