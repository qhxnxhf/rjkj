...
<body>
	<form id="myFormId" action="<c:url value='/sys/role/add' />" method="post" target="frmright">
	...
	<table class="tableStyle" formMode="transparent">
		...
		<tr>
			...
			<input id="CSRFToken" name="CSRFToken" type="hidden" value="${CSRFToken}"/>
				<input type="text" name="roleName" class="validate[required]" watermark="请输入" style="width:200px;" /><span class="star">*</span>
		...
		<tr>
			...
			<td>
				<input type="text" name="roleCode" class="validate[required,custom[noSpecialCaracters]]" watermark="请输入英文或数字" style="width:200px;" /><span class="star">*</span>
				
			</td>
		</tr>
		<tr>
			<td width="150">简介：</td>
			<td><input type="text" name="roleRemark"  value="" class="validate[length[0,20]]" style="width:200px;" /><span class="star">*</span></td>
		</tr>
