 ...
 * @author: Henry Yan
 */
@WebService(endpointInterface = "com.rjkj.webservice.LeaveWebService", serviceName = "LeaveWebService")
public class LeaveWebServiceImpl implements LeaveWebService {
    ...
    public int daysBetween(Date startDate, Date endDate) {
        ...
        logger.info("日期比较：startDate={},  相差 {} 天。", startDate,  result);
        return result;
    }
